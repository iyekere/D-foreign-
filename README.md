...
<div class="container">
    <div class="header">
        ...
        <div class="nav-buttons">
            <!-- Guest Controls -->
            <button id="showLoginBtn" class="btn auth-btn" onclick="showAuth('login')">Log In</button>
            <button id="showSignupBtn" class="btn auth-btn" onclick="showAuth('signup')">Sign Up</button>
